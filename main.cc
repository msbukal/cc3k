  ...
  if (!dlcmode) {
    ...
    try {
        while (true) {
            ...
            cout << "Spawn character: s (shade), d (drow), v (vampire), t (troll), g (goblin), h (sheep)" << endl;
            cout << "Directional commands: no, so, we, ea, ne, se, sw, nw" << endl;
            cout << "Attack: a + directional command. Use potion: u + directional command" << endl;
            cout << "Freeze (testing): f. Quit: q, quit, exit. Restart: r" << endl;
